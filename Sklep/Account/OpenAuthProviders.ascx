<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OpenAuthProviders.ascx.cs" Inherits="Sklep.Account.OpenAuthProviders" %>

<div id="socialLoginList">
    <h4>Użyj do zalogowania konta innej usługi.</h4>
    <hr />
